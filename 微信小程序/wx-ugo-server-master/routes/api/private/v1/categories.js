...
router.put("/:id/attributes/:attrId",
	...
	function(req,res,next) {
		...
		var params = {};
		params["attr_name"] = req.body.attr_name;
		params["cat_id"] = req.params.id;
		params["attr_sel"] = req.body.attr_sel;
		params["attr_write"] = req.body.attr_sel == "many" ? "list" : "manual";
		if(req.body.attr_vals && req.body.attr_vals != "") {
			params["attr_vals"] = req.body.attr_vals;
		} else {
			params["attr_vals"] = "";
		}
